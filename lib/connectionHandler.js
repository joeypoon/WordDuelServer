...
export function connectionHandler(socket) {
    ...
    socket.on(events.players.findActiveFriends, data => connectionHandlers.onPlayerFindActiveFriends(socket, data));
    socket.on(events.players.challengeFriend, data => connectionHandlers.onPlayerChallengeFriend(socket, data));
    socket.on(events.players.challengeResponse, data => connectionHandlers.onChallengeResponse(socket, data));
